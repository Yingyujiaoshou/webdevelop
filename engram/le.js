! function(n, t) { "use strict"; "object" == typeof module && "object" == typeof module.exports ? module.exports = n.document ? t(n, !0) : function(n) { if (!n.document) throw new Error("jQuery requires a window with a document"); return t(n) } : t(n) }("undefined" != typeof window ? window : this, function(n, t) {
    ...
    function fi(n, t, r) {
        ...
        return i.grep(n, function(n) { return lt.call(t, n) > -1 !== r && 1 === n.nodeType })
    }
    ...
    function ar(n, t, i) {
        ...
        if (void 0 === i && 1 === n.nodeType)
            if (r = "data-" + t.replace(ie, "-$&").toLowerCase(), i = n.getAttribute(r), "string" == typeof i) {
                try { i = "true" === i ? !0 : "false" === i ? !1 : "null" === i ? null : +i + "" === i ? +i : te.test(i) ? JSON.parse(i) : i } catch (u) {}
                e.set(n, t, i)
            } else i = void 0;
        return i
    }
    ...
    function si(n, t, r, u, f, e) {
        var o, s;
        if ("object" == typeof t) { "string" != typeof r && (u = u || r, r = void 0); for (s in t) si(n, s, r, u, t[s], e); return n }
        if (null == u && null == f ? (f = r, u = r = void 0) : null == f && ("string" == typeof r ? (f = u, u = void 0) : (f = u, u = r, r = void 0)), f === !1) f = nt;
        else if (!f) return n;
        return 1 === e && (o = f, f = function(n) { return i().off(n), o.apply(this, arguments) }, f.guid = o.guid || (o.guid = i.guid++)), n.each(function() { i.event.add(this, t, f, u, r) })
    }
    ...
    function tt(n, t, u, e) {
        ...
        if (v && (l = gr(t, n[0].ownerDocument, !1, n, e), p = l.firstChild, 1 === l.childNodes.length && (l = p), p || e)) {
            for (c = i.map(o(l, "script"), le), a = c.length; v > h; h++) s = l, h !== k && (s = i.clone(s, !0, !0), a && i.merge(c, o(s, "script"))), u.call(n[h], s, h);
            if (a)
                for (w = c[c.length - 1].ownerDocument, i.map(c, ae), h = 0; a > h; h++) s = c[h], kr.test(s.type || "") && !r.access(s, "globalEval") && i.contains(w, s) && (s.src ? i._evalUrl && i._evalUrl(s.src) : gi(s.textContent.replace(ce, ""), w))
        }
        return n
    }
    ...
    function vu(n, t, r) {
        ...
        if (n.getClientRects().length && (u = n.getBoundingClientRect()[t]), 0 >= u || null == u) {
            if (u = ht(n, t, e), (0 > u || null == u) && (u = n.style[t]), hi.test(u)) return u;
    ...
    function we(n, t, u) {
        var f, y, w, c, b, s, o, l, k = "width" in t || "height" in t,
            ...
            a = n.nodeType && bt(n),
            e = r.get(n, "fxshow");
        u.queue || (c = i._queueHooks(n, "fx"), null == c.unqueued && (c.unqueued = 0, b = c.empty.fire, c.empty.fire = function() { c.unqueued || b() }), c.unqueued++, v.always(function() {
            v.always(function() {
                c.unqueued--;
    ...
    function l(n, t, r) {
        var e, o, s = 0,
            ...
            u = f.promise({
                ...
                duration: r.duration,
                tweens: [],
                createTween: function(t, r) { var f = i.Tween(n, u.opts, t, r, u.opts.specialEasing[t] || u.opts.easing); return u.tweens.push(f), f },
                stop: function(t) {
                    var i = 0,
            ...
            h = u.props;
        for (be(h, u.opts.specialEasing); a > s; s++)
    ...
    function ai(n, t, r, u) {
        var f;
        if (i.isArray(t)) i.each(t, function(t, i) { r || ke.test(n) ? u(n, i) : ai(n + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, r, u) });
    ...
    function lf(n) { return i.isWindow(n) ? n : 9 === n.nodeType && n.defaultView }
    var y = [],
        u = n.document,
    ...
    i.fn = i.prototype = {
        ...
        constructor: i,
        length: 0,
        toArray: function() { return p.call(this) },
        get: function(n) { return null != n ? 0 > n ? this[n + this.length] : this[n] : p.call(this) },
    ...
    i.extend({
        ...
        noop: function() {},
        isFunction: function(n) { return "function" === i.type(n) },
        isArray: Array.isArray,
        isWindow: function(n) { return null != n && n === n.window },
        isNumeric: function(n) { var t = i.type(n); return ("number" === t || "string" === t) && !isNaN(n - parseFloat(n)) },
        isPlainObject: function(n) { var t, i; return n && "[object Object]" === ki.call(n) ? (t = yf(n)) ? (i = vt.call(t, "constructor") && t.constructor, "function" == typeof i && di.call(i) === pf) : !0 : !1 },
        isEmptyObject: function(n) { for (var t in n) return !1; return !0 },
        type: function(n) { return null == n ? n + "" : "object" == typeof n || "function" == typeof n ? at[ki.call(n)] || "object" : typeof n },
        globalEval: function(n) { gi(n) },
        camelCase: function(n) { return n.replace(bf, "ms-").replace(kf, df) },
        ...
        trim: function(n) { return null == n ? "" : (n + "").replace(wf, "") },
        makeArray: function(n, t) { var r = t || []; return null != n && (ui(Object(n)) ? i.merge(r, "string" == typeof n ? [n] : n) : ri.call(r, n)), r },
        inArray: function(n, t, i) { return null == t ? -1 : lt.call(t, n, i) },
        merge: function(n, t) { for (var u = +t.length, i = 0, r = n.length; u > i; i++) n[r++] = t[i]; return n.length = r, n },
        grep: function(n, t, i) { for (var u, f = [], r = 0, e = n.length, o = !i; e > r; r++) u = !t(n[r], r), u !== o && f.push(n[r]); return f },
        map: function(n, t, i) {
            var e, u, r = 0,
                f = [];
            if (ui(n))
        ...
        guid: 1,
        proxy: function(n, t) { var u, f, r; return "string" == typeof t && (u = n[t], t = n, n = u), i.isFunction(n) ? (f = p.call(arguments, 2), r = function() { return n.apply(t || this, f.concat(p.call(arguments))) }, r.guid = n.guid = n.guid || i.guid++, r) : void 0 },
        now: Date.now,
        support: f
    });
    ...
    v = function(n) {
        function u(n, t, r, u) {
            ...
            if (!u && ((t ? t.ownerDocument || t : h) !== i && b(t), t = t || i, c)) {
                ...
                if (f.qsa && !lt[n + " "] && (!o || !o.test(n))) {
                    ...
                    if (g) try { return k.apply(r, p.querySelectorAll(g)), r } catch (nt) {} finally { a === e && t.removeAttribute("id") }
                }
            }
        ...
        function ei(n) {
            for (var o, u, r, s = n.length, h = t.relative[n[0].type], c = h || t.relative[" "], i = h ? 1 : 0, l = pt(function(n) { return n === o }, c, !0), a = pt(function(n) { return nt(o, n) > -1 }, c, !0), f = [function(n, t, i) { var r = !h && (i || t !== ht) || ((o = t).nodeType ? l(n, t, i) : a(n, t, i)); return o = null, r }]; s > i; i++)
        ...
        var rt, f, t, st, oi, ft, bt, si, ht, w, ut, b, i, s, c, o, d, ct, et, e = "sizzle" + 1 * new Date,
            ...
            pi = function() { b() },
            lr = pt(function(n) { return n.disabled === !0 }, { dir: "parentNode", next: "legend" });
        try {
        ...
        b = u.setDocument = function(n) {
            ...
            return l !== i && 9 === l.nodeType && l.documentElement ? (i = l, s = i.documentElement, c = !oi(i), h !== i && (u = i.defaultView) && u.top !== u && (u.addEventListener ? u.addEventListener("unload", pi, !1) : u.attachEvent && u.attachEvent("onunload", pi)), f.attributes = a(function(n) { return n.className = "i", !n.getAttribute("className") }), f.getElementsByTagName = a(function(n) { return n.appendChild(i.createComment("")), !n.getElementsByTagName("*").length }), f.getElementsByClassName = ot.test(i.getElementsByClassName), f.getById = a(function(n) { return s.appendChild(n).id = e, !i.getElementsByName || !i.getElementsByName(e).length }), f.getById ? (t.find.ID = function(n, t) { if ("undefined" != typeof t.getElementById && c) { var i = t.getElementById(n); return i ? [i] : [] } }, t.filter.ID = function(n) { var t = n.replace(y, p); return function(n) { return n.getAttribute("id") === t } }) : (delete t.find.ID, t.filter.ID = function(n) { var t = n.replace(y, p); return function(n) { var i = "undefined" != typeof n.getAttributeNode && n.getAttributeNode("id"); return i && i.value === t } }), t.find.TAG = f.getElementsByTagName ? function(n, t) { return "undefined" != typeof t.getElementsByTagName ? t.getElementsByTagName(n) : f.qsa ? t.querySelectorAll(n) : void 0 } : function(n, t) {
                var i, r = [],
                    f = 0,
                    u = t.getElementsByTagName(n);
                if ("*" === n) { while (i = u[f++]) 1 === i.nodeType && r.push(i); return r }
                return u
            }, t.find.CLASS = f.getElementsByClassName && function(n, t) { if ("undefined" != typeof t.getElementsByClassName && c) return t.getElementsByClassName(n) }, d = [], o = [], (f.qsa = ot.test(i.querySelectorAll)) && (a(function(n) {
        ...
        u.matchesSelector = function(n, t) {
            if ((n.ownerDocument || n) !== i && b(n), t = t.replace(fr, "='$1']"), f.matchesSelector && c && !lt[t + " "] && (!d || !d.test(t)) && (!o || !o.test(t))) try { var r = ct.call(n, t); if (r || f.disconnectedMatch || n.document && 11 !== n.document.nodeType) return r } catch (e) {}
        ...
        u.uniqueSort = function(n) {
            var r, u = [],
                t = 0,
                i = 0;
            if (ut = !f.detectDuplicates, w = !f.sortStable && n.slice(0), n.sort(kt), ut) { while (r = n[i++]) r === n[i] && (t = u.push(i)); while (t--) n.splice(u[t], 1) }
            return w = null, n
        };
        ...
        t = u.selectors = {
            ...
            filter: {
                ...
                ATTR: function(n, t, i) { return function(r) { var f = u.attr(r, n); return null == f ? "!=" === t : t ? (f += "", "=" === t ? f === i : "!=" === t ? f !== i : "^=" === t ? i && 0 === f.indexOf(i) : "*=" === t ? i && f.indexOf(i) > -1 : "$=" === t ? i && f.slice(-i.length) === i : "~=" === t ? (" " + f.replace(ir, " ") + " ").indexOf(i) > -1 : "|=" === t ? f === i || f.slice(0, i.length + 1) === i + "-" : !1) : !0 } },
                        ...
                        if (d) {
                            ...
                            if (b = [o ? d.firstChild : d.lastChild], o && g) {
                                for (c = d, y = c[e] || (c[e] = {}), w = y[c.uniqueID] || (y[c.uniqueID] = {}), p = w[n] || [], a = p[0] === v && p[1], l = a && p[2], c = a && d.childNodes[a]; c = ++a && c && c[k] || (l = a = 0) || b.pop();)
                                    if (1 === c.nodeType && ++l && c === t) { w[n] = [v, a, l]; break }
            ...
            pseudos: {
                ...
                eq: it(function(n, t, i) { return [0 > i ? i + t : i] }),
                even: it(function(n, t) { for (var i = 0; t > i; i += 2) n.push(i); return n }),
                odd: it(function(n, t) { for (var i = 1; t > i; i += 2) n.push(i); return n }),
                lt: it(function(n, t, i) { for (var r = 0 > i ? i + t : i; --r >= 0;) n.push(r); return n }),
                gt: it(function(n, t, i) { for (var r = 0 > i ? i + t : i; ++r < t;) n.push(r); return n })
            }
        };
        ...
        return ki.prototype = t.filters = t.pseudos, t.setFilters = new ki, ft = u.tokenize = function(n, i) {
            ...
            if (r = r || [], 1 === h.length) {
                ...
                for (s = vt.needsContext.test(n) ? 0 : e.length; s--;) { if (o = e[s], t.relative[a = o.type]) break; if ((v = t.find[a]) && (u = v(o.matches[0].replace(y, p), ni.test(e[0].type) && ri(i.parentNode) || i))) { if (e.splice(s, 1), n = u.length && yt(e), !n) return k.apply(r, u), r; break } }
            }
            return (l || bt(n, h))(u, i, !c, r, !i || ni.test(n) && ri(i.parentNode) || i), r
        }, f.sortStable = e.split("").sort(kt).join("") === e, f.detectDuplicates = !!ut, b(), f.sortDetached = a(function(n) { return 1 & n.compareDocumentPosition(i.createElement("fieldset")) }), a(function(n) { return n.innerHTML = "<a href='#'><\/a>", "#" === n.firstChild.getAttribute("href") }) || ii("type|href|height|width", function(n, t, i) { if (!i) return n.getAttribute(t, "type" === t.toLowerCase() ? 1 : 2) }), f.attributes && a(function(n) { return n.innerHTML = "<input/>", n.firstChild.setAttribute("value", ""), "" === n.firstChild.getAttribute("value") }) || ii("value", function(n, t, i) { if (!i && "input" === n.nodeName.toLowerCase()) return n.defaultValue }), a(function(n) { return null == n.getAttribute("disabled") }) || ii(dt, function(n, t, i) { var r; if (!i) return n[t] === !0 ? t.toLowerCase() : (r = n.getAttributeNode(t)) && r.specified ? r.value : null }), u
    }(n);
    i.find = v;
    i.expr = v.selectors;
    ...
    i.fn.extend({
        find: function(n) {
            ...
            for (r = this.pushStack([]), t = 0; u > t; t++) i.find(n, f[t], r);
            return u > 1 ? i.uniqueSort(r) : r
        },
        filter: function(n) { return this.pushStack(fi(this, n || [], !1)) },
        not: function(n) { return this.pushStack(fi(this, n || [], !0)) },
        is: function(n) { return !!fi(this, "string" == typeof n && ir.test(n) ? i(n) : n || [], !1).length }
    });
    fr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    i.fn.extend({
        ...
        index: function(n) { return n ? "string" == typeof n ? lt.call(i(n), this[0]) : lt.call(this, n.jquery ? n[0] : n) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1 },
    ...
    i.Callbacks = function(n) {
        ...
        var f, r, h, e, t = [],
            ...
            s = {
                add: function() { return t && (r && !f && (u = t.length - 1, o.push(r)), function e(r) { i.each(r, function(r, u) { i.isFunction(u) ? n.unique && s.has(u) || t.push(u) : u && u.length && "string" !== i.type(u) && e(u) }) }(arguments), r && !f && c()), this },
                remove: function() {
                ...
                disable: function() { return e = o = [], t = r = "", this },
                disabled: function() { return !t },
                lock: function() { return e = o = [], r || f || (t = r = ""), this },
                locked: function() { return !!e },
                fireWith: function(n, t) { return e || (t = t || [], t = [n, t.slice ? t.slice() : t], o.push(t), f || c()), this },
    ...
    i.extend({
        Deferred: function(t) {
            var u = [
                ...
                f = {
                    ...
                    "catch": function(n) { return f.then(null, n) },
                    pipe: function() {
                        var n = arguments;
                    ...
                    promise: function(n) { return null != n ? i.extend(n, f) : f }
                },
                r = {};
        ...
        when: function(n) {
            ...
            if (1 >= f && (cr(n, r.done(o(t)).resolve, r.reject), "pending" === r.state() || i.isFunction(u[t] && u[t].then))) return r.then();
    ...
    a = function(n, t, r, u, f, e, o) {
        var s = 0,
            c = n.length,
            h = null == r;
        if ("object" === i.type(r)) { f = !0; for (s in r) a(n, t, s, r[s], !0, e, o) } else if (void 0 !== u && (f = !0, i.isFunction(u) || (o = !0), h && (o ? (t.call(n, u), t = null) : (h = t, t = function(n, t, r) { return h.call(i(n), r) })), t))
    ...
    ot.prototype = {
        ...
        get: function(n, t) { return void 0 === t ? this.cache(n) : n[this.expando] && n[this.expando][i.camelCase(t)] },
    ...
    i.fn.extend({
        data: function(n, t) {
            ...
            return "object" == typeof n ? this.each(function() { e.set(this, n) }) : a(this, function(t) { var i; if (u && void 0 === t) { if ((i = e.get(u, n), void 0 !== i) || (i = ar(u, n), void 0 !== i)) return i } else this.each(function() { e.set(this, n, t) }) }, null, t, arguments.length > 1, null, !0)
        },
        removeData: function(n) { return this.each(function() { e.remove(this, n) }) }
    });
    i.extend({
        queue: function(n, t, u) { var f; if (n) return (t = (t || "fx") + "queue", f = r.get(n, t), u && (!f || i.isArray(u) ? f = r.access(n, t, i.makeArray(u)) : f.push(u)), f || []) },
    ...
    ei = {};
    i.fn.extend({ show: function() { return g(this, !0) }, hide: function() { return g(this) }, toggle: function(n) { return "boolean" == typeof n ? n ? this.show() : this.hide() : this.each(function() { bt(this) ? i(this).show() : i(this).hide() }) } });
    ...
    i.event = {
        ...
        add: function(n, t, u, f, e) {
            ...
            if (a)
                for (u.handler && (v = u, u = v.handler, e = v.selector), e && i.find.matchesSelector(kt, e), u.guid || (u.guid = i.guid++), (p = a.events) || (p = a.events = {}), (y = a.handle) || (y = a.handle = function(t) { if ("undefined" != typeof i && i.event.triggered !== t.type) return i.event.dispatch.apply(n, arguments) }), t = (t || "").match(h) || [""], b = t.length; b--;) w = nu.exec(t[b]) || [], o = d = w[1], k = (w[2] || "").split(".").sort(), o && (s = i.event.special[o] || {}, o = (e ? s.delegateType : s.bindType) || o, s = i.event.special[o] || {}, c = i.extend({ type: o, origType: d, data: f, handler: u, guid: u.guid, selector: e, needsContext: e && i.expr.match.needsContext.test(e), namespace: k.join(".") }, v), (l = p[o]) || (l = p[o] = [], l.delegateCount = 0, s.setup && s.setup.call(n, f, k, y) !== !1 || n.addEventListener && n.addEventListener(o, y)), s.add && (s.add.call(n, c), c.handler.guid || (c.handler.guid = u.guid)), e ? l.splice(l.delegateCount++, 0, c) : l.push(c), i.event.global[o] = !0)
        },
        ...
        addProp: function(n, t) { Object.defineProperty(i.Event.prototype, n, { enumerable: !0, configurable: !0, get: i.isFunction(t) ? function() { if (this.originalEvent) return t(this.originalEvent) } : function() { if (this.originalEvent) return this.originalEvent[n] }, set: function(t) { Object.defineProperty(this, n, { enumerable: !0, configurable: !0, writable: !0, value: t }) } }) },
        fix: function(n) { return n[i.expando] ? n : new i.Event(n) },
        special: { load: { noBubble: !0 }, focus: { trigger: function() { if (this !== tu() && this.focus) return (this.focus(), !1) }, delegateType: "focusin" }, blur: { trigger: function() { if (this === tu() && this.blur) return (this.blur(), !1) }, delegateType: "focusout" }, click: { trigger: function() { if ("checkbox" === this.type && this.click && i.nodeName(this, "input")) return (this.click(), !1) }, _default: function(n) { return i.nodeName(n.target, "a") } }, beforeunload: { postDispatch: function(n) { void 0 !== n.result && n.originalEvent && (n.originalEvent.returnValue = n.result) } } }
    };
    ...
    i.fn.extend({ on: function(n, t, i, r) { return si(this, n, t, i, r) }, one: function(n, t, i, r) { return si(this, n, t, i, r, 1) }, off: function(n, t, r) { var u, f; if (n && n.preventDefault && n.handleObj) return u = n.handleObj, i(n.delegateTarget).off(u.namespace ? u.origType + "." + u.namespace : u.origType, u.selector, u.handler), this; if ("object" == typeof n) { for (f in n) this.off(f, t, n[f]); return this } return t !== !1 && "function" != typeof t || (r = t, t = void 0), r === !1 && (r = nt), this.each(function() { i.event.remove(this, n, r, t) }) } });
    ...
    i.fn.extend({
        detach: function(n) { return uu(this, n, !0) },
        remove: function(n) { return uu(this, n) },
        text: function(n) { return a(this, function(n) { return void 0 === n ? i.text(this) : this.empty().each(function() { 1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || (this.textContent = n) }) }, null, n, arguments.length) },
        append: function() {
        ...
        before: function() { return tt(this, arguments, function(n) { this.parentNode && this.parentNode.insertBefore(n, this) }) },
        after: function() { return tt(this, arguments, function(n) { this.parentNode && this.parentNode.insertBefore(n, this.nextSibling) }) },
        empty: function() { for (var n, t = 0; null != (n = this[t]); t++) 1 === n.nodeType && (i.cleanData(o(n, !1)), n.textContent = ""); return this },
        clone: function(n, t) { return n = null == n ? !1 : n, t = null == t ? n : t, this.map(function() { return i.clone(this, n, t) }) },
        html: function(n) {
    ...
    i.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function(n, t) { i.fn[n] = function(n) { for (var u, f = [], e = i(n), o = e.length - 1, r = 0; o >= r; r++) u = r === o ? this : this.clone(!0), i(e[r])[t](u), ri.apply(f, u.get()); return this.pushStack(f) } });
    var fu = /^margin/,
        hi = new RegExp("^(" + vr + ")(?!px)[a-z%]+$", "i"),
        gt = function(t) { var i = t.ownerDocument.defaultView; return i && i.opener || (i = n), i.getComputedStyle(t) };
    ! function() {
        function r() {
            if (t) {
        ...
        t.style && (t.style.backgroundClip = "content-box", t.cloneNode(!0).style.backgroundClip = "", f.clearCloneStyle = "content-box" === t.style.backgroundClip, e.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", e.appendChild(t), i.extend(f, { pixelPosition: function() { return r(), o }, boxSizingReliable: function() { return r(), s }, pixelMarginRight: function() { return r(), h }, reliableMarginLeft: function() { return r(), c } }))
    }();
    ...
    i.extend({
        cssHooks: { opacity: { get: function(n, t) { if (t) { var i = ht(n, "opacity"); return "" === i ? "1" : i } } } },
        ...
        css: function(n, t, r, u) { var f, s, o, e = i.camelCase(t); return t = i.cssProps[e] || (i.cssProps[e] = cu(e) || e), o = i.cssHooks[t] || i.cssHooks[e], o && "get" in o && (f = o.get(n, !0, r)), void 0 === f && (f = ht(n, t, u)), "normal" === f && t in ou && (f = ou[t]), "" === r || r ? (s = parseFloat(f), r === !0 || isFinite(s) ? s || 0 : f) : f }
    });
    i.each(["height", "width"], function(n, t) {
        i.cssHooks[t] = {
            get: function(n, r, u) { if (r) return !ye.test(i.css(n, "display")) || n.getClientRects().length && n.getBoundingClientRect().width ? vu(n, t, u) : yr(n, pe, function() { return vu(n, t, u) }) },
            set: function(n, r, u) {
                var f, e = u && gt(n),
    ...
    i.each({ margin: "", padding: "", border: "Width" }, function(n, t) {
        i.cssHooks[n + t] = { expand: function(i) { for (var r = 0, f = {}, u = "string" == typeof i ? i.split(" ") : [i]; 4 > r; r++) f[n + w[r] + t] = u[r] || u[r - 2] || u[0]; return f } };
    ...
    i.fn.extend({
        css: function(n, t) {
            return a(this, function(n, t, r) {
                var f, e, o = {},
                    u = 0;
                if (i.isArray(t)) { for (f = gt(n), e = t.length; e > u; u++) o[t[u]] = i.css(n, t[u], !1, f); return o }
    ...
    s.prototype = {
        ...
        cur: function() { var n = s.propHooks[this.prop]; return n && n.get ? n.get(this) : s.propHooks._default.get(this) },
        run: function(n) { var t, r = s.propHooks[this.prop]; return this.pos = this.options.duration ? t = i.easing[this.easing](n, this.options.duration * n, 0, 1, this.options.duration) : t = n, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), r && r.set ? r.set(this) : s.propHooks._default.set(this), this }
    };
    ...
    i.speed = function(n, t, r) {
        var f = n && "object" == typeof n ? i.extend({}, n) : { complete: r || !r && t || i.isFunction(n) && n, duration: n, easing: r && t || t && !i.isFunction(t) && t };
    ...
    i.extend({
        ...
        attrHooks: { type: { set: function(n, t) { if (!f.radioValue && "radio" === t && i.nodeName(n, "input")) { var r = n.value; return n.setAttribute("type", t), r && (n.value = r), t } } } },
    ...
    i.fn.extend({
        addClass: function(n) {
            ...
            if (i.isFunction(n)) return this.each(function(t) { i(this).addClass(n.call(this, t, b(this))) });
        ...
        removeClass: function(n) {
            ...
            if (i.isFunction(n)) return this.each(function(t) { i(this).removeClass(n.call(this, t, b(this))) });
        ...
        toggleClass: function(n, t) {
            var u = typeof n;
            return "boolean" == typeof t && "string" === u ? t ? this.addClass(n) : this.removeClass(n) : i.isFunction(n) ? this.each(function(r) { i(this).toggleClass(n.call(this, r, b(this), t), t) }) : this.each(function() {
                var t, e, f, o;
                if ("string" === u)
    ...
    i.fn.extend({
        val: function(n) {
            ...
            return arguments.length ? (f = i.isFunction(n), this.each(function(r) {
                var u;
                1 === this.nodeType && (u = f ? n.call(this, r, i(this).val()) : n, null == u ? u = "" : "number" == typeof u ? u += "" : i.isArray(u) && (u = i.map(u, function(n) { return null == n ? "" : n + "" })), t = i.valHooks[this.type] || i.valHooks[this.nodeName.toLowerCase()], t && "set" in t && void 0 !== t.set(this, u, "value") || (this.value = u))
    ...
    i.extend({
        valHooks: {
            option: { get: function(n) { var t = i.find.attr(n, "value"); return null != t ? t : i.trim(i.text(n)).replace(rf, " ") } },
            select: {
                get: function(n) {
                    for (var e, t, o = n.options, r = n.selectedIndex, u = "select-one" === n.type, s = u ? null : [], h = u ? r + 1 : o.length, f = 0 > r ? h : u ? r : 0; h > f; f++)
    ...
    i.each(["radio", "checkbox"], function() {
        i.valHooks[this] = { set: function(n, t) { if (i.isArray(t)) return n.checked = i.inArray(i(n).val(), t) > -1 } };
    ...
    var ct = n.location,
        uf = i.now(),
        li = /\?/;
    i.parseXML = function(t) { var r; if (!t || "string" != typeof t) return null; try { r = (new n.DOMParser).parseFromString(t, "text/xml") } catch (u) { r = void 0 } return r && !r.getElementsByTagName("parsererror").length || i.error("Invalid XML: " + t), r };
    var ke = /\[\]$/,
        ff = /\r?\n/g,
    ...
    i.param = function(n, t) {
        ...
        if (i.isArray(n) || n.jquery && !i.isPlainObject(n)) i.each(n, function() { f(this.name, this.value) });
        else
    ...
    return yi.href = ct.href, i.extend({
        ...
        ajax: function(t, r) {
            ...
            var a, o, k, y, d, l, s, v, g, p, f = i.ajaxSetup({}, r),
                ...
                e = {
                    ...
                    overrideMimeType: function(n) { return null == s && (f.mimeType = n), this },
            ...
            if (ft = "abort", it.add(f.complete), e.done(f.success), e.fail(f.error), a = hf(vi, f, r, e)) {
                ...
                f.async && f.timeout > 0 && (d = n.setTimeout(function() { e.abort("timeout") }, f.timeout));
                try {
                    s = !1;
                    a.send(rt, b)
                } catch (et) {
    ...
    }), i.each(["get", "post"], function(n, t) { i[t] = function(n, r, u, f) { return i.isFunction(r) && (f = f || u, u = r, r = void 0), i.ajax(i.extend({ url: n, type: t, dataType: f, data: r, success: u }, i.isPlainObject(n) && n)) } }), i._evalUrl = function(n) { return i.ajax({ url: n, type: "GET", dataType: "script", cache: !0, async: !1, global: !1, throws: !0 }) }, i.fn.extend({
        wrapAll: function(n) { var t; return this[0] && (i.isFunction(n) && (n = n.call(this[0])), t = i(n, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function() { for (var n = this; n.firstElementChild;) n = n.firstElementChild; return n }).append(this)), this },
        ...
        wrap: function(n) { var t = i.isFunction(n); return this.each(function(r) { i(this).wrapAll(t ? n.call(this, r) : n) }) },
    ...
    }), wi = [], ii = /(=)\?(?=&|$)|\?\?/, i.ajaxSetup({ jsonp: "callback", jsonpCallback: function() { var n = wi.pop() || i.expando + "_" + uf++; return this[n] = !0, n } }), i.ajaxPrefilter("json jsonp", function(t, r, u) {
        ...
        if (s || "jsonp" === t.dataTypes[0]) return (f = t.jsonpCallback = i.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(ii, "$1" + f) : t.jsonp !== !1 && (t.url += (li.test(t.url) ? "&" : "?") + t.jsonp + "=" + f), t.converters["script json"] = function() { return o || i.error(f + " was not called"), o[0] }, t.dataTypes[0] = "json", e = n[f], n[f] = function() { o = arguments }, u.always(function() {
            void 0 === e ? i(n).removeProp(f) : n[f] = e;
            t[f] && (t.jsonpCallback = r.jsonpCallback, wi.push(f));
            o && i.isFunction(e) && e(o[0]);
            o = e = void 0
        }), "script")
    }), f.createHTMLDocument = function() { var n = u.implementation.createHTMLDocument("").body; return n.innerHTML = "<form><\/form><form><\/form>", 2 === n.childNodes.length }(), i.parseHTML = function(n, t, r) { if ("string" != typeof n) return []; "boolean" == typeof t && (r = t, t = !1); var s, e, o; return t || (f.createHTMLDocument ? (t = u.implementation.createHTMLDocument(""), s = t.createElement("base"), s.href = u.location.href, t.head.appendChild(s)) : t = u), e = rr.exec(n), o = !r && [], e ? [t.createElement(e[1])] : (e = gr([n], t, o), o && o.length && i(o).remove(), i.merge([], e.childNodes)) }, i.fn.load = function(n, t, r) {
        var u, o, s, f = this,
            e = n.indexOf(" ");
        return e > -1 && (u = i.trim(n.slice(e)), n = n.slice(0, e)), i.isFunction(t) ? (r = t, t = void 0) : t && "object" == typeof t && (o = "POST"), f.length > 0 && i.ajax({ url: n, type: o || "GET", dataType: "html", data: t }).done(function(n) {
            s = arguments;
            f.html(u ? i("<div>").append(i.parseHTML(n)).find(u) : n)
        }).always(r && function(n, t) { f.each(function() { r.apply(this, s || [n.responseText, t, n]) }) }), this
        ...
        offset: function(n) { if (arguments.length) return void 0 === n ? this : this.each(function(t) { i.offset.setOffset(this, n, t) }); var u, f, t, e, r = this[0]; if (r) return r.getClientRects().length ? (t = r.getBoundingClientRect(), t.width || t.height ? (e = r.ownerDocument, f = lf(e), u = e.documentElement, { top: t.top + f.pageYOffset - u.clientTop, left: t.left + f.pageXOffset - u.clientLeft }) : t) : { top: 0, left: 0 } },
        position: function() {
            if (this[0]) {
                var t, r, u = this[0],
                    n = { top: 0, left: 0 };
                return "fixed" === i.css(u, "position") ? r = u.getBoundingClientRect() : (t = this.offsetParent(), r = this.offset(), i.nodeName(t[0], "html") || (n = t.offset()), n = { top: n.top + i.css(t[0], "borderTopWidth", !0), left: n.left + i.css(t[0], "borderLeftWidth", !0) }), { top: r.top - n.top - i.css(u, "marginTop", !0), left: r.left - n.left - i.css(u, "marginLeft", !0) }
            }
        },
        offsetParent: function() { return this.map(function() { for (var n = this.offsetParent; n && "static" === i.css(n, "position");) n = n.offsetParent; return n || kt }) }
    }), i.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(n, t) {
        var r = "pageYOffset" === t;
        i.fn[n] = function(i) { return a(this, function(n, i, u) { var f = lf(n); return void 0 === u ? f ? f[t] : n[i] : void(f ? f.scrollTo(r ? f.pageXOffset : u, r ? u : f.pageYOffset) : n[i] = u) }, n, i, arguments.length) }
    }), i.each(["top", "left"], function(n, t) { i.cssHooks[t] = eu(f.pixelPosition, function(n, r) { if (r) return (r = ht(n, t), hi.test(r) ? i(n).position()[t] + "px" : r) }) }), i.each({ Height: "height", Width: "width" }, function(n, t) {
        i.each({ padding: "inner" + n, content: t, "": "outer" + n }, function(r, u) {
            i.fn[u] = function(f, e) {
                var o = arguments.length && (r || "boolean" != typeof f),
                    s = r || (f === !0 || e === !0 ? "margin" : "border");
                return a(this, function(t, r, f) { var e; return i.isWindow(t) ? 0 === u.indexOf("outer") ? t["inner" + n] : t.document.documentElement["client" + n] : 9 === t.nodeType ? (e = t.documentElement, Math.max(t.body["scroll" + n], e["scroll" + n], t.body["offset" + n], e["offset" + n], e["client" + n])) : void 0 === f ? i.css(t, r, s) : i.style(t, r, f, s) }, t, o ? f : void 0, o)
            }
        })
    }), i.fn.extend({ bind: function(n, t, i) { return this.on(n, null, t, i) }, unbind: function(n, t) { return this.off(n, null, t) }, delegate: function(n, t, i, r) { return this.on(t, n, i, r) }, undelegate: function(n, t, i) { return 1 === arguments.length ? this.off(n, "**") : this.off(t, n || "**", i) } }), i.parseJSON = JSON.parse, "function" == typeof define && define.amd && define("jquery", [], function() { return i }), af = n.jQuery, vf = n.$, i.noConflict = function(t) { return n.$ === i && (n.$ = vf), t && n.jQuery === i && (n.jQuery = af), i }, t || (n.jQuery = n.$ = i), i
}),
...
function(n) {
    n.fn.modal = function(t) {
        t = n.extend({ toggle: "", backdrop: '<div id="modalBackdrop"><\/div>', onBeforeToggle: null, onAfterToggle: null }, t);
        var i = n(t.backdrop),
            u = function() {
                if ($body.append(i), vinbintry.client.isTouchEnabled() && vinbintry.events) i.on("clicktap", f);
                else i.on("click", f);
                setTimeout(function() {
                    $view.addClass("blur");
                    i.addClass("show")
            ...
            f = function() {
                n(".modal-overlay").each(function() {
                    var t = n(this);
                    t.removeClass("show")
                });
                r()
            };
        return n.each(this, function() {
            var i = n(this).addClass("modal-overlay"),
                f = n(t.toggle);
            ...
            i.close = function() { i.removeClass("show") }
        }), this.open = function() {
...
function(n) {
    n.fn.selectable = function(t) {
        t = n.extend({ multiSelect: !0, onActivateRow: null, onClearRow: null, onAnchorChange: null, onAnchorClear: null }, t);
        var i = function(n) { if (n.hasClass("selectable") && (n.addClass("active"), t.onActivateRow)) t.onActivateRow(n) },
            o = function(t, r) {
                i(r);
                var u = t.find("tr.anchor");
                i(u);
            ...
            s = function(n) {
                n.removeClass("anchor");
                t.onAnchorClear && t.onAnchorClear()
            },
            u = function(n) {
                var t = n.find("tr.active:first");
                t.hasClass("anchor") || e(n, t)
            };
        return n.each(this, function() {
            var h = n(this).addClass("no-select").find("tbody");
            h.on("click", "tr.selectable", function(c) {
                var l = n(this);
                t.multiSelect && c.ctrlKey ? l.hasClass("active") ? h.find("tr.active").length > 1 && (f(l), l.hasClass("anchor") && u(h)) : (i(l), u(h)) : t.multiSelect && c.shiftKey ? l.hasClass("anchor") || (r(h), o(h, l), u(h)) : t.multiSelect ? l.hasClass("active") ? (r(h), s(l)) : (r(h), i(l), e(h, l)) : l.hasClass("active") || (r(h), i(l))
            })
        }), this.clearRows = function() {
            var t = n(this).find("tbody");
            r(t)
        }, this
    }
}(jQuery);
var $window = $(window),
    ...
    $view = $("#view"),
    $document = $(document);
$(".hover-tip").hover(function() {
    var t = $(this),
        n = t.offset();
    n.top -= 24;
    n.left += 32;
    t.find(".hover-message").css(n).removeClass("hidden")
}, function() { $(this).find(".hover-message").addClass("hidden") });
...
vinbintry.forms = function() {
    var i = function() {
            $("input, select[required]").on("change", r);
        ...
        u = function(n, t) {
            t.closest("form").find("input[name=" + t.attr("name") + "], select[name=" + t.attr("name") + "]").each(function() {
        ...
        f = function(t) {
            var i = $(this),
                r = n(i.find("input, select[required]").not("[disabled]"));
            return r ? (alert(r), i.find(".invalid").first().focus(), t.stopImmediatePropagation(), !1) : !0
        },
        ...
        t = function(n) {
            var t = $(n),
                i = t.attr("title");
            return n.validity.valueMissing ? t.data("valuemissing") || i || "Field is required" : n.validity.typeMismatch ? t.data("typemismatch") || t.data("invalid") || i || "Field is invalid" : n.validity.patternMismatch ? t.data("patternmismatch") || t.data("invalid") || i || "Field is invalid" : t.data("invalid") || i || "Field is invalid"
        },
        o = function(n) {
            var t = $(this);
            n.target.type != "submit" || n.isDefaultPrevented() ? t.removeData("$clickedButton") : t.data("$clickedButton", $(n.target))
        };
    return { init: i, checkFormFields: n }
}();
$document.ready(function() { vinbintry.forms.init() });
vinbintry.page = function() {
    var t = function(n) {
            sessionStorage.isAdFree = n.IsAdFree;
        ...
        i = function() {
            vinbintry.settings = $html.data("clientsettings");
            vinbintry.settings.isPublic || vinbintry.client.setAdFree(!0);
            $html.hasClass("account-login") || $html.hasClass("account-register") ? n() : vinbintry.client.isAuthenticated() && $.extend(vinbintry.settings.services, JSON.parse(sessionStorage.services));
            vinbintry.client.isDynamicFont() && $window.resize(function() { vinbintry.client.resetFontSize() })
        };
    return { init: i, setSessionStorage: t, clearSessionStorage: n }
}();
vinbintry.page.init();
vinbintry.events = function() {
    var n = 750,
        t = 50,
        i = function() {
            $.event.special.clicktap = {
                setup: function() {
                    var u = $(this),
                        i = !1;
                    if (vinbintry.client.isTouchEnabled()) {
                        var r = !1,
                            f = 0,
                            e = 0,
                            o = null;
                        u.bind("touchstart", function(t) {
                            i = !0;
                            r = !1;
                            var u = t.originalEvent.touches ? t.originalEvent.touches[0] : t;
                            f = u.clientX;
                            e = u.clientY;
                            o = setTimeout(function() { r = !0 }, n)
                        }).bind("touchend", function(n) {
                            if (clearTimeout(o), !r) {
                                var i = n.originalEvent.changedTouches[0] ? n.originalEvent.changedTouches[0] : n,
                                    u = i.clientX - f,
                                    s = i.clientY - e,
                                    h = Math.sqrt(u * u + s * s);
                    ...
                    u.bind("click", function(n) {
                        i ? i = !1 : $(n.target).trigger("clicktap");
                    })
                },
                teardown: function() {
                    var n = $(this);
                    vinbintry.client.isTouchEnabled() && n.unbind("touchstart").unbind("touchend");
                    n.unbind("click")
                }
            }
        };
...
$document.ready(function() { vinbintry.events.init() });
vinbintry.templates = function() {
    var t = function() { $("[data-template]").each(function() { n(this) }) },
        n = function(t) {
            var i = $(t),
                r = i.data("template");
            i.find("[data-template]").each(function() { n(this) });
            vinbintry.templates[r] || (vinbintry.templates[r] = i.html(), i.empty().removeAttr("data-template").attr("data-container", r))
        };
    return { init: function() { t() } }
}();
$document.ready(function() { vinbintry.templates.init() });
vinbintry.services = function() {
    var n = function(n, t) {
        ...
        i = function(n, t, i, r, u, f, e) {
            if (!vinbintry.client.isStorageSupported()) {
                f || alert("Private Browsing must be turned off to use this website.");
                r && r(t);
                return
            }
            $.ajax({ url: n, type: "POST", async: !0, contentType: "application/json;charset=utf-8", headers: { Authorization: "Bearer " + (e || sessionStorage.bearerToken) }, data: JSON.stringify(t) }).done(function(n) {
                if (n && n.Message == "Validation failed") {
                    f || alert("Validation failed.\n");
                    location.href = vinbintry.settings.homeUrl;
                    return
                }
                ...
                n && n.Capacity && vinbintry.account && vinbintry.account.showWarnings(n);
                i && i(n)
            }).fail(function(n) { n && n.responseJSON && n.responseJSON.Message == "Authentication failed" ? location.href = vinbintry.settings.loginUrl : n && n.responseJSON && n.responseJSON.Message == "Authorization failed" ? location.href = vinbintry.settings.homeUrl : (f || alert("Connection to the server failed.\n\nCheck your internet connection and try again.\n"), r && r(n)) }).always(function(n) { u && u(n) })
        };
    return { showInProgress: n, hideInProgress: t, post: i }
}();
vinbintry.user = function() {
    var t = $("#loginForm"),
        n = $("#feedbackOverlay"),
        i = $("#adminTransfer"),
        f = $("#authenticatedAdminTransfer"),
        e = $("#passwordAdminTransfer"),
        r = function() {
            $("#sectionName").text(sessionStorage.sectionName);
        ...
        u = function() {
            n.modal({ toggle: "#feedbackOpen" });
            $("#feedbackForm").submit(l)
        },
        o = function() {
        ...
        s = function(n) {
            if (n.preventDefault(), !vinbintry.client.isCorsSupported()) { alert("This website does not support Internet Explorer 9.\nPlease upgrade to one of the following:\n\nGoogle Chrome\nMozilla Firefox\nApple Safari\nInternet Explorer 11\nInternet Explorer 10\n"); return }
            var o = $(this),
                s = $("#loginSubmit"),
                h = o.input();
            vinbintry.services.showInProgress(o, s);
            vinbintry.settings.isPublic || (h.UserName = vinbintry.settings.hostPrefix + h.UserName);
            vinbintry.services.post(vinbintry.settings.services.root + vinbintry.settings.services.authentication, h, function(n) {
                if (n && n.IsInstructor)
                    if (n.IsAuthenticated && !n.IsTemporary) {
                        var h = n.IsTemporary ? e : f;
                        h.find("[name=BearerToken]").val(n.BearerToken);
                        h.find("[name=IsAdministrator]").val(n.IsAdministrator);
                        h.find("[name=IsAdFree]").val(n.IsAdFree);
                        h.find("[name=FirstName]").val(n.FirstName);
                        h.find("[name=LastName]").val(n.LastName);
                        h.find("[name=AccountId]").val(n.AccountId);
                        h.find("[name=AccountName]").val(n.AccountName);
                        h.submit()
                    } else i.find("[name=UserName]").val(t.find("[name=UserName]").val()), i.find("[name=Password]").val(t.find("[name=Password]").val()), i.submit();
                else n && n.IsAuthenticated ? (vinbintry.page.setSessionStorage(n), n.IsTemporary && o.data("updatepassword") ? location.href = vinbintry.settings.updatePasswordUrl : o.data("redirecthome") ? location.href = vinbintry.settings.homeUrl : (vinbintry.client.setAuthentication(), vinbintry.session.allowLessonResubmit() || location.reload(!1), $.extend(vinbintry.settings.services, JSON.parse(sessionStorage.services)), vinbintry.lesson.isSecure ? vinbintry.session.getLessonContent() : vinbintry.session.loadLessonData(), r(), u(), c(o), vinbintry.headers && vinbintry.headers.init(), vinbintry.controls && vinbintry.controls.resetAssignmentList(), vinbintry.services.hideInProgress(o, s))) : (vinbintry.services.hideInProgress(o, s), alert("Log in failed.\n\nCheck your username and password.\n"))
            }, function() { vinbintry.services.hideInProgress(o, s) })
        },
        h = function(n) {
            if (n.preventDefault(), !vinbintry.client.isCorsSupported()) { alert("This website does not support Internet Explorer 9.\nPlease upgrade to one of the following:\n\nGoogle Chrome\nMozilla Firefox\nApple Safari\nInternet Explorer 11\nInternet Explorer 10\n"); return }
            var t = $(this),
                i = $("#resetSubmit"),
                r = t.input();
            vinbintry.services.showInProgress(t, i);
            vinbintry.services.post(vinbintry.settings.services.root + vinbintry.settings.services.resetUserPassword, r, function(n) { n && n.Success ? ($("#passwordResetForm").addClass("hidden"), $("#passwordResetSuccess").removeClass("hidden")) : alert("We were unable to match your e-mail address to an account") }, null, function() { vinbintry.services.hideInProgress(t, i) })
        },
        c = function(n) {
        ...
        l = function(t) {
            ...
            var i = $(this),
                r = $("#feedbackSubmit"),
                u = i.input();
            vinbintry.services.showInProgress(n, r);
            vinbintry.services.post(vinbintry.settings.services.root + vinbintry.settings.services.sendFeedback, u, function() {
                alert("Thank you for the feedback.");
                i[0].reset();
                n.close()
            }, null, function() { vinbintry.services.hideInProgress(n, r) })
        };
    return {
        init: function() {
            if (vinbintry.client.isAuthenticated()) r(), u();
            else {
                $("#loginTool").on("clicktap", o);
                t.submit(s);
                $("#passwordResetForm").submit(h)
            }
        }
    }
}();
$document.ready(function() { vinbintry.user.init() });
vinbintry.saveTimeoutId = 0;
vinbintry.session = function() {
    var n = !1,
        t = null,
        y = Date.now(),
        p = 3e5,
        ...
        f = $("#lessonBody"),
        w = function() {
            if (sessionStorage[vinbintry.lesson.lessonId + ".beginUtcTicks"] && (vinbintry.lesson.isInProgress = !0), vinbintry.client.isAuthenticated()) {
                vinbintry.lesson.isSecure ? e() : i();
                $body.on("click", "a", it)
            } else vinbintry.settings.isPublic ? (vinbintry.controls.showReset(), vinbintry.lesson.isSecure && $("#loginMessage").removeClass("hidden")) : location.href = vinbintry.settings.loginUrl
        },
        e = function() {
            var n = $("#lessonBody");
            vinbintry.services.showInProgress(n);
            vinbintry.services.post(vinbintry.settings.services.root + vinbintry.settings.services.getLessonContent, vinbintry.lesson.lessonId, function(t) { t && t.ProblemsHtml ? ($("#problemsContent").html(t.ProblemsHtml), vinbintry.problems.init(), vinbintry.problems.radio.init(), vinbintry.problems.multistate && vinbintry.problems.multistate.init(), vinbintry.problems.sentenceparts && vinbintry.problems.sentenceparts.init(), vinbintry.problems.modifiers && vinbintry.problems.modifiers.init(), vinbintry.problems.prepositions && vinbintry.problems.prepositions.init(), vinbintry.problems.multiradio && vinbintry.problems.multiradio.init(), vinbintry.problems.parallel && vinbintry.problems.parallel.init(), vinbintry.services.hideInProgress(n), i()) : vinbintry.services.hideInProgress(n) }, function() { vinbintry.services.hideInProgress(n) })
        },
        i = function() {
            var n = $("#lessonBody");
            vinbintry.services.showInProgress(n);
            vinbintry.services.post(vinbintry.settings.services.root + vinbintry.settings.services.getStudentLesson, { ModuleId: vinbintry.lesson.moduleId, LessonId: vinbintry.lesson.lessonId, RecordId: vinbintry.record.RecordId }, function(t) {
                var i, r, u, f, e;
                t && t.StudentLesson && (i = $("#lessonHeaderControls .scroll-left"), r = i.attr("href"), t.StudentLesson.PreviousLessonLink ? (i.attr("href", r.substring(0, r.indexOf("module")) + t.StudentLesson.PreviousLessonLink.LinkUrl), i.attr("title", t.StudentLesson.PreviousLessonLink.LinkText)) : r.indexOf("module") > 0 && (i.attr("href", r.substring(0, r.indexOf("module")) + "student-dashboard"), i.attr("title", "Student Dashboard")), u = $("#lessonHeaderControls .scroll-right"), f = u.attr("href"), t.StudentLesson.NextLessonLink ? (u.attr("href", f.substring(0, f.indexOf("module")) + t.StudentLesson.NextLessonLink.LinkUrl), u.attr("title", t.StudentLesson.NextLessonLink.LinkText)) : f.indexOf("module") > 0 && (u.attr("href", f.substring(0, f.indexOf("module")) + "student-dashboard"), u.attr("title", "Student Dashboard")), t.StudentLesson.Course && (vinbintry.lesson.course = t.StudentLesson.Course), t.StudentLesson.Record && t.StudentLesson.Record.Course && (vinbintry.record.Course = t.StudentLesson.Record.Course), (vinbintry.lesson.course || vinbintry.record.Course) && (e = vinbintry.record.Course ? JSON.parse(vinbintry.record.Course) : vinbintry.lesson.course, vinbintry.problems.setCourse(e)), t.StudentLesson.Record && t.StudentLesson.Record.LessonId && (vinbintry.record.BeginUtcTicks = t.StudentLesson.Record.BeginUtcTicks, vinbintry.record.RecordId = t.StudentLesson.Record.RecordId, vinbintry.record.IsViewable = t.StudentLesson.Record.IsViewable, vinbintry.record.Scored = t.StudentLesson.Record.Scored, vinbintry.record.Interactions = t.StudentLesson.Record.Interactions, vinbintry.record.IsViewable && t.StudentLesson.Record.Interactions && (vinbintry.problems.setInteractions(), vinbintry.scoring.scoreProblems(!t.StudentLesson.Record.SubmitUtcTicks)), vinbintry.record.ScoreRaw = t.StudentLesson.Record.ScoreRaw, vinbintry.record.ScoreScaled = t.StudentLesson.Record.ScoreScaled, vinbintry.scoring.setScoreBoard(), t.StudentLesson.Record.SubmitUtcTicks ? (vinbintry.controls.setSubmitted(), c() && vinbintry.controls.showReset(), h() || $("#problemsContent").addClass("hidden"), vinbintry.scoring.displayReport(vinbintry.record.IsViewable), s(), vinbintry.lesson.isScored = !0, vinbintry.lesson.isSubmitted = !0) : (o(), vinbintry.lesson.isScored = !1, vinbintry.lesson.isSubmitted = !1), window.scrollTo(0, 0)));
                vinbintry.services.hideInProgress(n)
            }, function() { vinbintry.services.hideInProgress(n) })
        },
        o = function() {
            sessionStorage[vinbintry.lesson.lessonId + ".beginUtcTicks"] = vinbintry.record.BeginUtcTicks;
            vinbintry.lesson.isInProgress = !0
        },
        s = function() {
            sessionStorage.removeItem(vinbintry.lesson.lessonId + ".beginUtcTicks");
            vinbintry.lesson.isInProgress = !1
        },
        b = function() {
            vinbintry.scoring.resetProblems();
            vinbintry.scoring.resetScoreBoard();
            vinbintry.scoring.resetReport();
            for (subject in vinbintry.lesson.subjects) vinbintry.lesson.subjects[subject].score = 0, vinbintry.lesson.subjects[subject].inCourse = !1;
            vinbintry.lesson.isSubmitted && (vinbintry.record.RecordId = null);
            vinbintry.record.ScoreRaw = 0;
            vinbintry.record.ScoreScaled = null;
            vinbintry.record.Scored = null;
            vinbintry.record.Interactions = null;
            (vinbintry.lesson.course || vinbintry.record.Course) && (vinbintry.record.Course = null, vinbintry.problems.setCourse(vinbintry.lesson.course));
            $("#problemsContent").removeClass("hidden");
            vinbintry.lesson.isInProgress = !1;
            vinbintry.lesson.isScored = !1;
            vinbintry.lesson.isSubmitted = !1
        },
        h = function() { return vinbintry.record.IsViewable && (!vinbintry.lesson.isTest && sessionStorage.allowLessonView.toString() == "true" || vinbintry.lesson.isTest && sessionStorage.allowTestView.toString() == "true") },
        c = function() { return !vinbintry.lesson.isTest && sessionStorage.allowLessonResubmit.toString() == "true" || vinbintry.lesson.isTest && sessionStorage.allowTestResubmit.toString() == "true" },
        k = function() { return vinbintry.problems.problemsAttempted() ? !0 : (alert("Answer all the questions before scoring."), a(), !1) },
        d = function() {
            vinbintry.scoring.scoreProblems();
            vinbintry.lesson.isScored = !0;
            alert(vinbintry.scoring.getScoreMessage());
            vinbintry.scoring.setScoreBoard();
            vinbintry.scoring.displayReport(!0);
            vinbintry.lesson.isInProgress = !1;
            vinbintry.lesson.isSubmitted = !1
        },
        l = function(n) {
            if (!n) {
                if (vinbintry.saveTimeoutId) return;
                var i = Date.now() - (t || y);
                n = Math.max(p - i, u)
            }
            vinbintry.saveTimeoutId = setTimeout(function() { r(!0) }, n)
        },
        r = function(i, r) {
            if (n && !r) { l(u); return }
            vinbintry.saveTimeoutId && (i || clearTimeout(vinbintry.saveTimeoutId), vinbintry.saveTimeoutId = 0);
            n = !0;
            vinbintry.services.post(vinbintry.settings.services.root + vinbintry.settings.services.saveStudentRecord, v(!1), function(n) {
                vinbintry.record.RecordId = n.RecordId;
                t = Date.now()
            }, null, function() {
                n = !1;
                r && (location.href = r)
        ...
        g = function() {
            var n = "",
                t = !1;
            return (vinbintry.client.isAuthenticated() || (n += "* Log in before submitting.\n"), vinbintry.problems.problemsAttempted() || (t = !0, n += "* Answer all the questions before submitting.\n"), n) ? (alert(n), t && a(), !1) : !0
        },
        a = function() { $("html, body").animate({ scrollTop: $(".unanswered").offset().top - 400 }, 1e3) },
        nt = function() {
            vinbintry.saveTimeoutId && (clearTimeout(vinbintry.saveTimeoutId), vinbintry.saveTimeoutId = 0);
            vinbintry.scoring.scoreProblems();
            vinbintry.lesson.isScored = !0;
            f.addClass("in-progress");
            vinbintry.services.post(vinbintry.settings.services.root + vinbintry.settings.services.saveStudentRecord, v(!0), function(n) {
                vinbintry.record.RecordId = n.RecordId;
                t = Date.now();
                alert("Lesson submitted.\n\n" + vinbintry.scoring.getScoreMessage());
                vinbintry.scoring.setScoreBoard();
                vinbintry.scoring.displayReport(!0);
                vinbintry.controls.resetAssignmentList();
                s();
                vinbintry.lesson.isSubmitted = !0
            }, function() { vinbintry.controls.enableSubmit() }, function() { f.removeClass("in-progress") })
        },
        v = function(n) { for (var t, f, r = [], u = [], i = 1; i <= vinbintry.lesson.qqq.length; i++) t = $("#" + i), (t.hasClass("correct") || t.hasClass("error") || t.hasClass("partial")) && u.push(i), f = t.data("selections"), r.push(f); return vinbintry.record.LessonId = vinbintry.lesson.lessonId, vinbintry.record.BeginUtcTicks = parseInt(sessionStorage[vinbintry.lesson.lessonId + ".beginUtcTicks"]), n && (vinbintry.record.SubmitUtcTicks = (new Date).getTime() * 1e4 + 621355968000000000), vinbintry.record.ScoreRaw = Math.round(vinbintry.record.ScoreRaw * 100) / 100, vinbintry.record.ScoreScaled = Math.round(vinbintry.record.ScoreRaw * 100 / vinbintry.lesson.totalPoints) / 100, vinbintry.record.Scored = JSON.stringify(u), vinbintry.record.Interactions = JSON.stringify(r), vinbintry.lesson.course && (vinbintry.record.Course = JSON.stringify(vinbintry.lesson.course)), vinbintry.record },
        tt = function(n) {
            if (48 < n.which && n.which < 58) {
                var t = n.which - 48;
                $(".header-toolbar, .lesson-toolbar").each(function() { $(this).children("button").eq(t - 1).click() })
            }
        },
        it = function(n) {
            if (vinbintry.saveTimeoutId) {
                var t = $(this),
                    i = t.attr("href"),
                    u = t.attr("target");
                i && !u && (n.preventDefault(), r(!1, i))
            }
        };
    return {
        init: function() {
            w();
            $document.on("keypress", tt)
        },
        getLessonContent: e,
        loadLessonData: i,
        initSession: o,
...
$document.ready(function() { vinbintry.session.init() });
vinbintry.headers = function() {
    var n = function() {
            var n = $(this),
                t = n.offset().top - 55;
        ...
        t = function() {
            ...
            $window.on("resize report", function() {
                i = n.offset().top - 140;
                r = n.offset().left;
                u = i + n.height() - t.height();
        ...
        i = function(n) {
            var t = n.offset().top - 135;
            n.parent(".lesson-toolbar-container").css("min-height", n.outerHeight() + "px");
            $window.scroll(function() { $window.scrollTop() > t ? n.addClass("fixed") : n.removeClass("fixed") });
            $window.on("resize report", function() { t = n.offset().top - 135 })
        };
    return {
        init: function() {
            $("#lessonHeaderControls").each(n);
            $("table.problems, table.with-sticky-header").each(t)
        },
        initLessonToolbar: i
    }
}();
$document.ready(function() { vinbintry.headers.init() });
vinbintry.instructions = function() {
    var n = function() {
            var n = $(this),
                i, t;
            n.empty();
        ...
        t = function() { window.open("/content/irregularverbs.pdf") };
    return {
        init: function() {
            $(".verb-check").on("click", n);
            $("#verbPrint").on("click", t)
        }
    }
}();
$document.ready(function() { vinbintry.instructions.init() });
vinbintry.controls = function() {
    var r = $(".reset-button"),
        u = $(".score-button"),
        f = $(".submit-button"),
        h = $("#assignmentsButton"),
        ...
        y = function() { vinbintry.client.isAuthenticated() ? (vinbintry.session.resetLesson(), o()) : location.reload(!1) },
        p = function() {
            if (!vinbintry.lesson.isScored) {
                if (c(), document.body.style.cursor = "wait", !vinbintry.session.validForScore()) {
                    l();
                    document.body.style.cursor = "auto";
                    return
                }
                vinbintry.session.scoreLesson();
                document.body.style.cursor = "auto"
            }
        },
        w = function() {
            if (!vinbintry.lesson.isSubmitted) {
                if (e(), document.body.style.cursor = "wait", !vinbintry.session.validForSubmit()) {
                    o();
                    document.body.style.cursor = "auto";
                    return
                }
                vinbintry.session.submitLesson();
                document.body.style.cursor = "auto"
            }
        },
        b = function(i) {
            if (i.stopPropagation(), n.hasClass("expanded")) {
                n.removeClass("expanded");
                s();
                return
            }(n.addClass("expanded"), k(), t.is(":empty")) && (vinbintry.services.showInProgress(n), vinbintry.services.post(vinbintry.settings.services.root + (vinbintry.client.isAuthenticated() ? vinbintry.settings.services.getStudentAssignments : vinbintry.settings.services.getTableOfContents), null, function(n) {
                var u, i, h, l, f, r, a, e, c, o, s;
                if (n && n.StudentAssignments) {
                    if (n.StudentAssignments.ModuleAssignments)
                        for (u = 0; u < n.StudentAssignments.ModuleAssignments.length; u++)
                            if (i = n.StudentAssignments.ModuleAssignments[u], i.Assignments.length > 0) {
                                for (h = $(vinbintry.templates.assignmentList.replace("{moduleTitle}", i.ModuleTitle).replace(/{moduleId}/g, i.ModuleId)), l = h.find("[data-container=assignmentRow]"), f = 0; f < i.Assignments.length; f++) r = i.Assignments[f], a = r.LessonDescriptor + ": " + (r.LessonTitle ? r.LessonTitle : i.ModuleTitle), l.append(vinbintry.templates.assignmentRow.replace("{lessonId}", r.LessonId).replace(/{lesson}/g, a).replace("{lessonUrl}", r.LessonUrl).replace("{class}", r.LessonId == vinbintry.lesson.lessonId ? "current-lesson" : ""));
                                t.append(h);
                                e = t.find("#module" + i.ModuleId + "Panel");
                                e.css("height", e.outerHeight() + "px");
                                i.ModuleId != vinbintry.lesson.moduleId ? e.addClass("collapsed") : t.find("#module" + i.ModuleId + "Link").addClass("expanded")
                            }
                    if (n.StudentAssignments.CompletedLessons)
                        for (lessonId in n.StudentAssignments.CompletedLessons) c = n.StudentAssignments.CompletedLessons[lessonId], o = "s0", c >= .8 ? o = "s80" : c >= .6 && (o = "s60"), s = $("#" + lessonId), s.find(".mark").addClass(o);
                    if (n.StudentAssignments.InProgressLessons)
                        for (lessonId in n.StudentAssignments.InProgressLessons) s = $("#" + lessonId), s.find(".mark").addClass("ip")
                }
            }, null, function() { vinbintry.services.hideInProgress(n) }))
        },
        k = function() {
            $body.append(i);
            i.on("clicktap", nt);
    ...
    return {
        init: function() {
            ...
            h.on("click", b);
            n.on("click", d);
            t.on("click", ".module-link", g)
        },
        setSubmitted: a,
        disableSubmit: e,
        enableSubmit: o,
        showReset: v,
        resetAssignmentList: tt
    }
}();
$document.ready(function() { vinbintry.controls.init() });
vinbintry.problems = function() {
    var n = 0,
        ...
        o = function(n) {
            var i = !1,
                t;
            $("[data-lessonid]").each(function() {
                var t = $(this),
                    u = t.data("lessonid"),
                    r = t.data("subject");
                n.indexOf(u) < 0 ? (t.addClass("hidden"), i = !0) : (t.removeClass("hidden"), r && (vinbintry.lesson.subjects[r].inCourse = !0))
            });
            t = 0;
            vinbintry.lesson.totalPoints = 0;
            $(".problem").each(function() {
                var n = $(this);
                n.hasClass("hidden") || n.closest(".problems").hasClass("hidden") || (vinbintry.lesson.totalPoints += vinbintry.lesson.weighting[t], t++, n.find(".id").text(t + "."))
            });
            vinbintry.lesson.isTest && $("#lessonSpecs").removeClass("hidden").text("(" + (i ? t : vinbintry.lesson.qqq.length) + " Problems, " + vinbintry.lesson.totalPoints + " Points)")
        },
        s = function() {
            var n = JSON.parse(vinbintry.record.Interactions);
            $(".problems").each(function() {
                var t = $(this);
                t.find(".problem").each(function() {
                    var t = $(this),
        ...
        u = function(n) { return n.hasClass("correct") || n.hasClass("error") ? !1 : (vinbintry.lesson.isInProgress || vinbintry.session.initSession(), !0) },
        h = function(n) {
            var i = "";
        ...
        c = function() {
            var n = !0;
            return $(".problems .problem").each(function() {
                var t = $(this),
                    i = t.closest(".problems");
                t.hasClass("hidden") || i.hasClass("hidden") || f(t) || (n = !1, l(t))
            }), n
        },
        ...
        v = function(n) { var t = ""; return (vinbintry.settings.isPublic || vinbintry.client.isAuthenticated() || (t += "* Log in before checking answer.\n"), f(n) || (t += "* 请先作答再看答案\n"), t) ? (alert(t), !1) : !0 },
        y = function() {
            var n = $(this);
        ...
        p = function() {
            ...
            n > 0 && t != n ? (n = t, vinbintry.client.isAuthenticated() && vinbintry.session.queueSave()) : n < 1 && (n = t);
            a(i)
        },
        w = function() {
            $(this).attr("disabled", "disabled");
            var t = $(this).closest(".problem");
            if (!v(t)) { $(this).removeAttr("disabled"); return }
            vinbintry.scoring.scoreProblem(t);
            vinbintry.client.isAuthenticated() && vinbintry.scoring.problemsScored() ? (vinbintry.controls.disableSubmit(), vinbintry.session.submitLesson()) : vinbintry.client.isAuthenticated() ? (vinbintry.scoring.setScoreBoard(), vinbintry.session.saveLesson()) : vinbintry.scoring.setScoreBoard();
        ...
        b = function() {
            var n = $(this),
                ...
                i = vinbintry.lesson.qqq[a],
                s, l;
            if (f == i) h.addClass("correct"), n.data("scoreScaled", 1);
            else {
                var e = r(n),
                    c = 0,
                    u = 0,
        ...
        k = function() {
            ...
            i && r.each(function(n) {
                var t = $(this);
                parseInt(i.charAt(n)) > 0 && t.addClass("on")
            })
        };
    return {
        init: function() {
            $(".problems .choice").on("clicktap", y);
            $(".problems .answer").on("click", w);
            $(".problems .problem").on("aftersaveselections", p);
            $(".problems .problem").on("calculatescore", b);
            $(".problems .problem").on("resetselections", e);
            $(".problems .problem").on("setselections", k)
        },
        $getProblem: i,
        $getChoices: t,
        $getSegments: r,
...
$document.ready(function() { vinbintry.problems.init() });
vinbintry.problems.radio = function() {
    var n = function(n, t) {
            var i = t.index(t.filter(".on"));
            n.data("selections", i.toString());
            n.trigger("aftersaveselections")
        },
        t = function() {
            var t = $(this);
            if (vinbintry.problems.isChoiceEnabled(t)) {
                var u = t.hasClass("on"),
                    i = vinbintry.problems.$getProblem(t),
                    r = vinbintry.problems.$getChoices(i);
                r.removeClass("on");
                u || t.addClass("on");
                n(i, r)
            }
        ...
        i = function() {
            var n = $(this),
                t = vinbintry.problems.$getChoices(n),
                i = parseInt(n.data("selections")),
                u = parseInt(this.id) - 1,
                r = parseInt(vinbintry.lesson.qqq[u]);
            i == r ? (t.addClass("correct"), n.data("scoreScaled", 1)) : (t.each(function(n) { $(this).addClass(n == i || n == r ? "error" : "correct") }), n.data("scoreScaled", 0))
        },
        r = function() {
            var t = $(this),
                i = vinbintry.problems.$getChoices(t),
                n = t.data("selections");
            (n || n == "0") && $(i[parseInt(n)]).addClass("on")
        };
    return {
        init: function() {
            $(".radio .choice").off("clicktap").on("clicktap", t);
...
$document.ready(function() { vinbintry.problems.radio.init() });
vinbintry.scoring = function() {
    var n = .8,
        i = "Good Job!",
        r = "Perfect Score!",
        e = "Suggested Lessons:",
        o = function(n) {
            var t = JSON.parse(vinbintry.record.Scored);
            $(".problems").each(function() {
                var i = $(this);
                i.find(".problem").each(function() {
                    var r = $(this),
                        e = parseInt(this.id) - 1;
                    !r.hasClass("hidden") && !i.hasClass("hidden") && (!n || t.indexOf(e + 1) > -1) && r.data("selections") && (r.find(".answer").attr("disabled", "disabled"), f(r, i), r.data("subject") && u(r.data()))
                });
                n || !i.data("subject") || i.hasClass("hidden") || u(i.data())
            })
        },
        u = function(t) {
            var i = vinbintry.lesson.subjects[t.subject].score / vinbintry.lesson.subjects[t.subject].points;
            i < n && vinbintry.lesson.subjects[t.subject].lessons.indexOf(t.lessonid) < 0 && vinbintry.lesson.subjects[t.subject].lessons.push(t.lessonid)
        },
        s = function() {
            $(".problems").each(function() {
                var n = $(this);
                n.find(".problem").each(function() {
                    var n = $(this);
        ...
        f = function(t, i) {
            if (!t.hasClass("correct") && !t.hasClass("error") && !t.hasClass("partial")) {
                i || (i = t.closest(".problems"));
                t.trigger("calculatescore");
                var e = t[0].id - 1,
                    u = t.data("subject") || i.data("subject"),
                    o = vinbintry.lesson.weighting[e],
                    r = t.data("scoreScaled"),
                    f = r * o;
                vinbintry.record.ScoreRaw += f;
                u && (vinbintry.lesson.subjects[u].score += f);
        ...
        h = function() {
            ...
            return $(".problems .problem").each(function() {
                var t = $(this),
                    i = t.closest(".problems");
                if (!t.hasClass("hidden") && !i.hasClass("hidden") && !(t.hasClass("correct") || t.hasClass("error") || t.hasClass("partial"))) return n = !1, !1
            }), n
        },
        c = function() {
            var n = Math.round(vinbintry.record.ScoreRaw * 100) / 100,
                i = t() + "% (" + n + "/" + vinbintry.lesson.totalPoints + ")";
            $(".student-score").html(i)
        },
        l = function() { $(".student-score").empty() },
        a = function(u) {
            var f = t(),
                s = f >= n * 100,
                e = $("#report"),
                o;
            if (e.removeClass("hidden"), e.append('<h2 class="report-overall">Overall Score: ' + f + '% <span class="report-overall-message' + (s ? " passed" : "") + '">' + (f == 100 ? r : f >= n * 100 ? i : "") + "<\/span><\/h2>"), u)
                for (subject in vinbintry.lesson.subjects) vinbintry.lesson.subjects[subject].inCourse && (o = Math.round(vinbintry.lesson.subjects[subject].score * 100 / vinbintry.lesson.subjects[subject].points), e.append('<div class="subject-report"><h5 class="subject-title">' + subject + '<\/h5><p class="subject-score">Score: ' + o + "%<\/p>" + p(o, vinbintry.lesson.subjects[subject].lessons) + "<\/div>"));
        ...
        t = function() { var n = Math.round(vinbintry.record.ScoreRaw * 100) / 100; return Math.round(n * 100 / vinbintry.lesson.totalPoints) },
        p = function(t, u) { var s, h, o, f, c; if (t == 100) return '<p class="subject-message passed">' + r + "<\/p>"; if (t >= n * 100) return '<p class="subject-message passed">' + i + "<\/p>"; if (u.length > 0) { for (s = u.join().split(","), h = "", o = 0; o < s.length; o++) f = vinbintry.lessons[s[o]], c = vinbintry.modules[f.ModuleId], h += '<a class="report-suggested-link" href="/module-' + c.ModuleId + "/" + c.RouteModule + "/" + f.RouteDescriptor + "/" + f.RouteTitle + '">' + f.Descriptor + " " + (f.Title.length > 21 ? "<br />" + f.Title : f.Title) + "<\/a>"; return '<dl class="report-suggested-lessons"><dt class="subject-message">' + e + "<\/dt><dd>" + h + "<\/dd><\/dl>" } };
    return { passingThreshold: function() { return n }, scoreProblems: o, resetProblems: s, scoreProblem: f, problemsScored: h, setScoreBoard: c, resetScoreBoard: l, displayReport: a, resetReport: v, getScoreMessage: y, getOverallScore: t }
}();
vinbintry.problems.multiradio = function() {
    var n = function(n) {
            var t = "";
            vinbintry.problems.$getChoices(n).each(function() { t += /[0-9]/.exec(this.className)[0] });
            n.data("selections", t);
            n.trigger("aftersaveselections")
        },
        t = function() {
            var t = $(this),
                n = t.closest(".choice"),
                i, r;
            vinbintry.problems.isChoiceEnabled(n) && (i = t.index(), r = parseInt(/[0-9]/.exec(n.get(0).className)[0]), n.removeClass("state" + r), n.addClass("state" + i))
        },
        i = function() {
            var t = $(this),
                i;
            vinbintry.problems.isChoiceEnabled(t) && (i = parseInt(/[0-9]/.exec(this.className)[0]), i > 0 ? t.addClass("on") : t.removeClass("on"), n(vinbintry.problems.$getProblem(t)))
        },
        r = function() {
            var t = $(this),
                r = vinbintry.problems.$getChoices(t),
                i = t.data("selections"),
                s = parseInt(this.id) - 1,
                n = vinbintry.lesson.qqq[s];
            if (i == n) r.addClass("correct"), t.data("scoreScaled", 1), r.each(function(t) {
                var i = $(this);
                i.find("ins:nth-child(" + (parseInt(n.charAt(t)) + 1) + ")").addClass("answer")
            });
            else {
                var u = n.replace(/0/g, "").length,
                    h = i.replace(/0/g, "").length,
                    f = 0,
                    e = 0,
                    o = 0;
                r.each(function(t) {
                    var r = $(this),
                        e = parseInt(n.charAt(t)) > 0,
                        o = parseInt(i.charAt(t)) > 0,
                        u = i.charAt(t) == n.charAt(t);
                    r.addClass(u ? "correct" : "error");
                    e && u && f++;
                    r.find("ins:nth-child(" + (parseInt(n.charAt(t)) + 1) + ")").addClass("answer")
                });
                e = Math.max(0, f - .5 * Math.max(0, h - u));
                o = e / u;
                t.data("scoreScaled", o)
            }
        },
        u = function() {
            var n = $(this),
            ...
            t.each(function(n) {
                var t = $(this);
                t.removeClass("on correct error");
                t.hasClass("state0") || t.removeClass("state" + i.charAt(n)).addClass("state0");
                t.find("ins.answer").removeClass("answer")
            });
            n.data("selections", "")
        },
        f = function() {
            ...
            n && i.each(function(t) {
                var i = $(this);
                parseInt(n.charAt(t)) > 0 && (i.addClass("on"), i.removeClass("state0").addClass("state" + n.charAt(t)))
            })
        };
    return {
        init: function() {
            $(".multi-radio .choice ins").on("clicktap", t);
            $(".multi-radio .choice").off("clicktap").on("clicktap", i);
            $(".multi-radio .problem").off("calculatescore").on("calculatescore", r);
            $(".multi-radio .problem").off("resetselections").on("resetselections", u);
            $(".multi-radio .problem").off("setselections").on("setselections", f)
        }
    }
}();
$document.ready(function() { vinbintry.problems.multiradio.init() })