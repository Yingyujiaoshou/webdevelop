...
cingletree.user = function() { var t = $("#loginForm"),
        n = $("#feedbackOverlay"),
        i = $("#adminTransfer"),
        f = $("#authenticatedAdminTransfer"),
        e = $("#passwordAdminTransfer"),
        r = function() { $("#sectionName").text(sessionStorage.sectionName);
        ...
        u = function() { n.modal({ toggle: "#feedbackOpen" });
            $("#feedbackForm").submit(l) },
        o = function() { $(this).addClass("disabled");
            $("#loginOverlay").addClass("show") },
        s = function(n) { if (n.preventDefault(), !cingletree.client.isCorsSupported()) { alert("This website does not support Internet Explorer 9.\nPlease upgrade to one of the following:\n\nGoogle Chrome\nMozilla Firefox\nApple Safari\nInternet Explorer 11\nInternet Explorer 10\n"); return } var o = $(this),
                s = $("#loginSubmit"),
                h = o.input();
            cingletree.services.showInProgress(o, s);
            cingletree.settings.isPublic || (h.UserName = cingletree.settings.hostPrefix + h.UserName);
            cingletree.services.post(cingletree.settings.services.root + cingletree.settings.services.authentication, h, function(n) { if (n && n.IsInstructor)
                    if (n.IsAuthenticated && !n.IsTemporary) { var h = n.IsTemporary ? e : f;
                        ...
                        h.submit() } else i.find("[name=UserName]").val(t.find("[name=UserName]").val()), i.find("[name=Password]").val(t.find("[name=Password]").val()), i.submit();
                else n && n.IsAuthenticated ? (cingletree.page.setSessionStorage(n), n.IsTemporary && o.data("updatepassword") ? location.href = cingletree.settings.updatePasswordUrl : o.data("redirecthome") ? location.href = cingletree.settings.homeUrl : (cingletree.client.setAuthentication(), cingletree.session.allowLessonResubmit() || location.reload(!1), $.extend(cingletree.settings.services, JSON.parse(sessionStorage.services)), cingletree.lesson.isSecure ? cingletree.session.getLessonContent() : cingletree.session.loadLessonData(), r(), u(), c(o), cingletree.headers && cingletree.headers.init(), cingletree.controls && cingletree.controls.resetAssignmentList(), cingletree.services.hideInProgress(o, s))) : (cingletree.services.hideInProgress(o, s), alert("Log in failed.\n\nCheck your username and password.\n")) }, function() { cingletree.services.hideInProgress(o, s) }) },
        h = function(n) { if (n.preventDefault(), !cingletree.client.isCorsSupported()) { alert("This website does not support Internet Explorer 9.\nPlease upgrade to one of the following:\n\nGoogle Chrome\nMozilla Firefox\nApple Safari\nInternet Explorer 11\nInternet Explorer 10\n"); return } var t = $(this),
                i = $("#resetSubmit"),
                r = t.input();
        ...
        c = function(n) { $("#loginOverlay").removeClass("show");
            n[0].reset() },
        l = function(t) { t.preventDefault(); var i = $(this),
                r = $("#feedbackSubmit"),
                u = i.input();
            cingletree.services.showInProgress(n, r);
            cingletree.services.post(cingletree.settings.services.root + cingletree.settings.services.sendFeedback, u, function() { alert("Thank you for the feedback.");
                i[0].reset();
                n.close() }, null, function() { cingletree.services.hideInProgress(n, r) }) }; return { init: function() { if (cingletree.client.isAuthenticated()) r(), u();
            else { $("#loginTool").on("clicktap", o);
                t.submit(s);
...
cingletree.session = function() { var n = !1,
        ...
        u = 50,
        f = $("#lessonBody"),
        w = function() { if (sessionStorage[cingletree.lesson.lessonId + ".beginUtcTicks"] && (cingletree.lesson.isInProgress = !0), cingletree.client.isAuthenticated()) { cingletree.lesson.isSecure ? e() : i();
                $body.on("click", "a", it) } else cingletree.settings.isPublic ? (cingletree.controls.showReset(), cingletree.lesson.isSecure && $("#loginMessage").removeClass("hidden")) : location.href = cingletree.settings.loginUrl },
        e = function() { var n = $("#lessonBody");
            cingletree.services.showInProgress(n);
            cingletree.services.post(cingletree.settings.services.root + cingletree.settings.services.getLessonContent, cingletree.lesson.lessonId, function(t) { t && t.ProblemsHtml ? ($("#problemsContent").html(t.ProblemsHtml), cingletree.problems.init(), cingletree.problems.radio.init(), cingletree.problems.multistate && cingletree.problems.multistate.init(), cingletree.problems.sentenceparts && cingletree.problems.sentenceparts.init(), cingletree.problems.modifiers && cingletree.problems.modifiers.init(), cingletree.problems.prepositions && cingletree.problems.prepositions.init(), cingletree.problems.multiradio && cingletree.problems.multiradio.init(), cingletree.problems.parallel && cingletree.problems.parallel.init(), cingletree.services.hideInProgress(n), i()) : cingletree.services.hideInProgress(n) }, function() { cingletree.services.hideInProgress(n) }) },
        i = function() { var n = $("#lessonBody");
            cingletree.services.showInProgress(n);
            cingletree.services.post(cingletree.settings.services.root + cingletree.settings.services.getStudentLesson, { ModuleId: cingletree.lesson.moduleId, LessonId: cingletree.lesson.lessonId, RecordId: cingletree.record.RecordId }, function(t) { var i, r, u, f, e;
                t && t.StudentLesson && (i = $("#lessonHeaderControls .scroll-left"), r = i.attr("href"), t.StudentLesson.PreviousLessonLink ? (i.attr("href", r.substring(0, r.indexOf("module")) + t.StudentLesson.PreviousLessonLink.LinkUrl), i.attr("title", t.StudentLesson.PreviousLessonLink.LinkText)) : r.indexOf("module") > 0 && (i.attr("href", r.substring(0, r.indexOf("module")) + "student-dashboard"), i.attr("title", "Student Dashboard")), u = $("#lessonHeaderControls .scroll-right"), f = u.attr("href"), t.StudentLesson.NextLessonLink ? (u.attr("href", f.substring(0, f.indexOf("module")) + t.StudentLesson.NextLessonLink.LinkUrl), u.attr("title", t.StudentLesson.NextLessonLink.LinkText)) : f.indexOf("module") > 0 && (u.attr("href", f.substring(0, f.indexOf("module")) + "student-dashboard"), u.attr("title", "Student Dashboard")), t.StudentLesson.Course && (cingletree.lesson.course = t.StudentLesson.Course), t.StudentLesson.Record && t.StudentLesson.Record.Course && (cingletree.record.Course = t.StudentLesson.Record.Course), (cingletree.lesson.course || cingletree.record.Course) && (e = cingletree.record.Course ? JSON.parse(cingletree.record.Course) : cingletree.lesson.course, cingletree.problems.setCourse(e)), t.StudentLesson.Record && t.StudentLesson.Record.LessonId && (cingletree.record.BeginUtcTicks = t.StudentLesson.Record.BeginUtcTicks, cingletree.record.RecordId = t.StudentLesson.Record.RecordId, cingletree.record.IsViewable = t.StudentLesson.Record.IsViewable, cingletree.record.Scored = t.StudentLesson.Record.Scored, cingletree.record.Interactions = t.StudentLesson.Record.Interactions, cingletree.record.IsViewable && t.StudentLesson.Record.Interactions && (cingletree.problems.setInteractions(), cingletree.scoring.scoreProblems(!t.StudentLesson.Record.SubmitUtcTicks)), cingletree.record.ScoreRaw = t.StudentLesson.Record.ScoreRaw, cingletree.record.ScoreScaled = t.StudentLesson.Record.ScoreScaled, cingletree.scoring.setScoreBoard(), t.StudentLesson.Record.SubmitUtcTicks ? (cingletree.controls.setSubmitted(), c() && cingletree.controls.showReset(), h() || $("#problemsContent").addClass("hidden"), cingletree.scoring.displayReport(cingletree.record.IsViewable), s(), cingletree.lesson.isScored = !0, cingletree.lesson.isSubmitted = !0) : (o(), cingletree.lesson.isScored = !1, cingletree.lesson.isSubmitted = !1), window.scrollTo(0, 0)));
                cingletree.services.hideInProgress(n) }, function() { cingletree.services.hideInProgress(n) }) },
        o = function() { sessionStorage[cingletree.lesson.lessonId + ".beginUtcTicks"] = cingletree.record.BeginUtcTicks;
            cingletree.lesson.isInProgress = !0 },
        s = function() { sessionStorage.removeItem(cingletree.lesson.lessonId + ".beginUtcTicks");
            cingletree.lesson.isInProgress = !1 },
        b = function() { cingletree.scoring.resetProblems();
            cingletree.scoring.resetScoreBoard();
            cingletree.scoring.resetReport(); for (subject in cingletree.lesson.subjects) cingletree.lesson.subjects[subject].score = 0, cingletree.lesson.subjects[subject].inCourse = !1;
            cingletree.lesson.isSubmitted && (cingletree.record.RecordId = null);
        ...
        h = function() { return cingletree.record.IsViewable && (!cingletree.lesson.isTest && sessionStorage.allowLessonView.toString() == "true" || cingletree.lesson.isTest && sessionStorage.allowTestView.toString() == "true") },
        c = function() { return !cingletree.lesson.isTest && sessionStorage.allowLessonResubmit.toString() == "true" || cingletree.lesson.isTest && sessionStorage.allowTestResubmit.toString() == "true" },
        k = function() { return cingletree.problems.problemsAttempted() ? !0 : (alert("Answer all the questions before scoring."), a(), !1) },
        d = function() { cingletree.scoring.scoreProblems();
        ...
        l = function(n) { if (!n) { if (cingletree.saveTimeoutId) return; var i = Date.now() - (t || y);
                n = Math.max(p - i, u) }
            cingletree.saveTimeoutId = setTimeout(function() { r(!0) }, n) },
        r = function(i, r) { if (n && !r) { l(u); return }
            cingletree.saveTimeoutId && (i || clearTimeout(cingletree.saveTimeoutId), cingletree.saveTimeoutId = 0);
            n = !0;
            cingletree.services.post(cingletree.settings.services.root + cingletree.settings.services.saveStudentRecord, v(!1), function(n) { cingletree.record.RecordId = n.RecordId;
        ...
        nt = function() { cingletree.saveTimeoutId && (clearTimeout(cingletree.saveTimeoutId), cingletree.saveTimeoutId = 0);
            cingletree.scoring.scoreProblems();
            cingletree.lesson.isScored = !0;
            f.addClass("in-progress");
            cingletree.services.post(cingletree.settings.services.root + cingletree.settings.services.saveStudentRecord, v(!0), function(n) { cingletree.record.RecordId = n.RecordId;
                t = Date.now();
                ...
                s();
                cingletree.lesson.isSubmitted = !0 }, function() { cingletree.controls.enableSubmit() }, function() { f.removeClass("in-progress") }) },
        v = function(n) { for (var t, f, r = [], u = [], i = 1; i <= cingletree.lesson.qqq.length; i++) t = $("#" + i), (t.hasClass("correct") || t.hasClass("error") || t.hasClass("partial")) && u.push(i), f = t.data("selections"), r.push(f); return cingletree.record.LessonId = cingletree.lesson.lessonId, cingletree.record.BeginUtcTicks = parseInt(sessionStorage[cingletree.lesson.lessonId + ".beginUtcTicks"]), n && (cingletree.record.SubmitUtcTicks = (new Date).getTime() * 1e4 + 621355968000000000), cingletree.record.ScoreRaw = Math.round(cingletree.record.ScoreRaw * 100) / 100, cingletree.record.ScoreScaled = Math.round(cingletree.record.ScoreRaw * 100 / cingletree.lesson.totalPoints) / 100, cingletree.record.Scored = JSON.stringify(u), cingletree.record.Interactions = JSON.stringify(r), cingletree.lesson.course && (cingletree.record.Course = JSON.stringify(cingletree.lesson.course)), cingletree.record },
        tt = function(n) { if (48 < n.which && n.which < 58) { var t = n.which - 48;
                $(".header-toolbar, .lesson-toolbar").each(function() { $(this).children("button").eq(t - 1).click() }) } },
        it = function(n) { if (cingletree.saveTimeoutId) { var t = $(this),
                    i = t.attr("href"),
                    u = t.attr("target");
                i && !u && (n.preventDefault(), r(!1, i)) } }; return { init: function() { w();
            $document.on("keypress", tt) }, getLessonContent: e, loadLessonData: i, initSession: o, resetLesson: b, allowLessonView: h, allowLessonResubmit: c, validForScore: k, scoreLesson: d, queueSave: l, saveLesson: r, validForSubmit: g, submitLesson: nt } }();
$document.ready(function() { cingletree.session.init() });
cingletree.headers = function() { var n = function() { var n = $(this),
                t = n.offset().top - 55;
        ...
        i = function(n) { var t = n.offset().top - 135;
            n.parent(".lesson-toolbar-container").css("min-height", n.outerHeight() + "px");
            $window.scroll(function() { $window.scrollTop() > t ? n.addClass("fixed") : n.removeClass("fixed") });
            $window.on("resize report", function() { t = n.offset().top - 135 }) }; return { init: function() { $("#lessonHeaderControls").each(n);
            $("table.problems, table.with-sticky-header").each(t) }, initLessonToolbar: i } }();
...
cingletree.controls = function() { var r = $(".reset-button"),
        ...
        b = function(i) { if (i.stopPropagation(), n.hasClass("expanded")) { n.removeClass("expanded");
                s(); return }(n.addClass("expanded"), k(), t.is(":empty")) && (cingletree.services.showInProgress(n), cingletree.services.post(cingletree.settings.services.root + (cingletree.client.isAuthenticated() ? cingletree.settings.services.getStudentAssignments : cingletree.settings.services.getTableOfContents), null, function(n) { var u, i, h, l, f, r, a, e, c, o, s; if (n && n.StudentAssignments) { if (n.StudentAssignments.ModuleAssignments)
                        for (u = 0; u < n.StudentAssignments.ModuleAssignments.length; u++)
                            if (i = n.StudentAssignments.ModuleAssignments[u], i.Assignments.length > 0) { for (h = $(cingletree.templates.assignmentList.replace("{moduleTitle}", i.ModuleTitle).replace(/{moduleId}/g, i.ModuleId)), l = h.find("[data-container=assignmentRow]"), f = 0; f < i.Assignments.length; f++) r = i.Assignments[f], a = r.LessonDescriptor + ": " + (r.LessonTitle ? r.LessonTitle : i.ModuleTitle), l.append(cingletree.templates.assignmentRow.replace("{lessonId}", r.LessonId).replace(/{lesson}/g, a).replace("{lessonUrl}", r.LessonUrl).replace("{class}", r.LessonId == cingletree.lesson.lessonId ? "current-lesson" : ""));
                                t.append(h);
                                e = t.find("#module" + i.ModuleId + "Panel");
                                e.css("height", e.outerHeight() + "px");
                                i.ModuleId != cingletree.lesson.moduleId ? e.addClass("collapsed") : t.find("#module" + i.ModuleId + "Link").addClass("expanded") }
                    if (n.StudentAssignments.CompletedLessons)
                        for (lessonId in n.StudentAssignments.CompletedLessons) c = n.StudentAssignments.CompletedLessons[lessonId], o = "s0", c >= .8 ? o = "s80" : c >= .6 && (o = "s60"), s = $("#" + lessonId), s.find(".mark").addClass(o); if (n.StudentAssignments.InProgressLessons)
                        for (lessonId in n.StudentAssignments.InProgressLessons) s = $("#" + lessonId), s.find(".mark").addClass("ip") } }, null, function() { cingletree.services.hideInProgress(n) })) },
...
cingletree.problems = function() { var n = 0,
        ...
        o = function(n) { var i = !1,
            ...
            $(".problem").each(function() { var n = $(this);
                n.hasClass("hidden") || n.closest(".problems").hasClass("hidden") || (cingletree.lesson.totalPoints += cingletree.lesson.weighting[t], t++, n.find(".id").text(t + ".")) });
        ...
        s = function() { var n = JSON.parse(cingletree.record.Interactions);
        ...
        c = function() { var n = !0; return $(".problems .problem").each(function() { var t = $(this),
                ...
                t.hasClass("hidden") || i.hasClass("hidden") || f(t) || (n = !1, l(t)) }), n },
        ...
        p = function() { var i = $(this),
            ...
            a(i) },
        w = function() { $(this).attr("disabled", "disabled"); var t = $(this).closest(".problem"); if (!v(t)) { $(this).removeAttr("disabled"); return }
        ...
        e = function() { var n = $(this),
            ...
            n.data("selections", "") },
        k = function() { var n = $(this),
                r = t(n),
                i = n.data("selections");
            i && r.each(function(n) { var t = $(this);
                parseInt(i.charAt(n)) > 0 && t.addClass("on") }) }; return { init: function() { $(".problems .choice").on("clicktap", y);
            ...
            $(".problems .problem").on("setselections", k) }, $getProblem: i, $getChoices: t, $getSegments: r, setCourse: o, setInteractions: s, isChoiceEnabled: u, problemsAttempted: c, resetSelections: e } }();
$document.ready(function() { cingletree.problems.init() });
...
$document.ready(function() { cingletree.problems.radio.init() });
cingletree.scoring = function() { var n = .8,
            ...
            o = function(n) { var t = JSON.parse(cingletree.record.Scored);
                $(".problems").each(function() { var i = $(this);
                    i.find(".problem").each(function() { var r = $(this),
                            e = parseInt(this.id) - 1;!r.hasClass("hidden") && !i.hasClass("hidden") && (!n || t.indexOf(e + 1) > -1) && r.data("selections") && (r.find(".answer").attr("disabled", "disabled"), f(r, i), r.data("subject") && u(r.data())) });
                    n || !i.data("subject") || i.hasClass("hidden") || u(i.data()) }) },
            u = function(t) { var i = cingletree.lesson.subjects[t.subject].score / cingletree.lesson.subjects[t.subject].points;
                i < n && cingletree.lesson.subjects[t.subject].lessons.indexOf(t.lessonid) < 0 && cingletree.lesson.subjects[t.subject].lessons.push(t.lessonid) },
            s = function() { $(".problems").each(function() { var n = $(this);
            ...
            f = function(t, i) { if (!t.hasClass("correct") && !t.hasClass("error") && !t.hasClass("partial")) { i || (i = t.closest(".problems"));
                    t.trigger("calculatescore"); var e = t[0].id - 1,
                        u = t.data("subject") || i.data("subject"),
                        o = cingletree.lesson.weighting[e],
                        r = t.data("scoreScaled"),
                        f = r * o;
                    cingletree.record.ScoreRaw += f;
                    u && (cingletree.lesson.subjects[u].score += f);
            ...
            h = function() { var n = !0; return $(".problems .problem").each(function() { var t = $(this),
            ...
            c = function() { var n = Math.round(cingletree.record.ScoreRaw * 100) / 100,
                    i = t() + "% (" + n + "/" + cingletree.lesson.totalPoints + ")";
                $(".student-score").html(i) },
            l = function() { $(".student-score").empty() },
            a = function(u) { var f = t(),
                    s = f >= n * 100,
                    e = $("#report"),
                    o; if (e.removeClass("hidden"), e.append('<h2 class="report-overall">Overall Score: ' + f + '% <span class="report-overall-message' + (s ? " passed" : "") + '">' + (f == 100 ? r : f >= n * 100 ? i : "") + "<\/span><\/h2>"), u)
                    for (subject in cingletree.lesson.subjects) cingletree.lesson.subjects[subject].inCourse && (o = Math.round(cingletree.lesson.subjects[subject].score * 100 / cingletree.lesson.subjects[subject].points), e.append('<div class="subject-report"><h5 class="subject-title">' + subject + '<\/h5><p class="subject-score">Score: ' + o + "%<\/p>" + p(o, cingletree.lesson.subjects[subject].lessons) + "<\/div>"));
                $window.trigger("report") },
            v = function() { var n = $("#report");
                n.addClass("hidden");
